...
public class SimpleSSLContextFactory implements SSLContextFactory {
    ...
    private void loadKeyStore(KeyStore ks, char[] passPhrase, String keyStoreFile)
        ...
        InputStream inputStream = SimpleSSLContextFactory.class.getClassLoader().getResourceAsStream(keyStoreFile);
        try {
